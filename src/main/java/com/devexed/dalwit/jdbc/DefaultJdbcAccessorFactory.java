...
public final class DefaultJdbcAccessorFactory
        implements AccessorFactory<PreparedStatement, Integer, ResultSet, Integer, SQLException> {
    ...
    private static final Map<Class<?>, JdbcAccessor> accessors = new HashMap<Class<?>, JdbcAccessor>() {{
        put(Boolean.TYPE, new JdbcAccessor() {
            @Override
            public void set(PreparedStatement statement, Integer index, Object value) throws SQLException {
            ...
            @Override
            public Object get(ResultSet resultSet, Integer index) throws SQLException {
